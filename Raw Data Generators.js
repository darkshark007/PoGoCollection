var REPO_URL = "https://github.com/pokemongo-dev-contrib/pokemongo-game-master/"
var DATA_FILE_URL = "https://raw.githubusercontent.com/pokemongo-dev-contrib/pokemongo-game-master/master/versions/latest/GAME_MASTER.json"

var pkdata;
window.fetch(DATA_FILE_URL).then(function(data,data2) {
  d1 = data;
  console.log(data);
  console.log(data2);
  return data.json().then(function(data,data2) {
    pkdata = data;
    ...
    for (var k in index) {
        ...
        if (!current.pokemonSettings.evolutionBranch) {
            ...
            for (k2 in current.pokemonSettings.evolutionBranch) {
                ...
                if (currentEvolution.evolution === undefined) continue;
